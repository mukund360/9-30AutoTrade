...
class TradeLogger:
    headers = [
        "trade_date", "portfolio", "side", "symbol", "strike", "expiry", "entry_time", "entry_price",
        "exit_time", "exit_price", "quantity", "reason", "gross_pnl", "capital_after_trade",
    ]
    ...
    def log_trade(self, trade_day: date, trade_row: dict) -> Path:
        ...
        with path.open("a", newline="", encoding="utf-8") as fh:
            csv.DictWriter(fh, fieldnames=self.headers).writerow(trade_row)
        return path
