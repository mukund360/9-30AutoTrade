...
from config_v2 import PORTFOLIOS, SQUARE_OFF_TIME, STARTING_CAPITAL, STRATEGY_START_TIME
from groww_client_v2 import GrowwClient, OptionInstrument
...
class ORBStrategyEngine:
    ...
    def totals(self) -> dict:
        ...
        total_mtm = sum(p.mtm() for p in self.positions)
